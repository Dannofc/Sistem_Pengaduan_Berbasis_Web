...
<head>
    ...
    <title>Lapor | Dispendukcapil Tanjung Bonai Aur</title>
            ...
            <div class="row">
                <div class="col-md-8 card-shadow-2 form-custom">
                    <form class="form-horizontal" role="form" method="post" action="private/validasi" enctype="multipart/form-data">
                        ...
                        <div class="form-group">
                            <label for="file" class="col-sm-3 control-label">Lampiran</label>
                            <div class="col-sm-6">
                                <div class="input-group">
                                    <div class="input-group-addon"><span class="glyphicon glyphicon-paperclip"></span></div>
                                    <input type="file" class="form-control" id="file" name="file"
                                        accept=".jpg,.jpeg,.png,.pdf,.doc,.docx,.xls,.xlsx,.ppt,.pptx,.txt,.zip,.rar,.gif,.bmp,.csv">
                                    <span class="input-group-addon" style="background:transparent;border:none;padding-left:8px;">
                                        <span class="text-muted">Opsional</span>
                                    </span>
                                </div>
                                <small class="text-muted">Format: gambar/dokumen (jpg, png, pdf, doc, dll). Maksimal 2MB.</small>
